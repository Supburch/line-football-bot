...
def build_penalty_shootout_flex(
    h_name: str,
    a_name: str,
    hs: int,
    as_: int,
                    ...
                    },
                    {
                        ...
                        "contents": [
                            ...
                            },
                            {
                                ...
                                "margin": "sm",
                                "flex": 1,
                                "weight": "bold" if is_fav else "regular",
                                "wrap": True,
                            },
                        ],
                    },
            ...
            bubbles.append(
                {
                    ...
                    "footer": {
                        ...
                        "contents": [
                            {
                                "type": "text",
                                "text": f"Updated: {datetime.now(Config.TZ).strftime('%H:%M')}",
                                "size": "xxs",
                                "align": "center",
                                "color": "#aaaaaa",
                            },
...
def build_upcoming_flex(matches, team_filter: str = None) -> FlexDict:
    ...
    for m in matches[:limit]:
        ...
        time_label = (
            f"🆓 {bkk_time}{stage_text}  📺 ช่อง29" if is_free else f"🕐 {bkk_time}{stage_text}"
        )
                ...
                "contents": [
                    {
                        ...
                        "size": "xs",
                        "color": time_color,
                        "weight": "bold" if is_free else "regular",
                    },
                    {
                        "type": "box",
                        "layout": "horizontal",
    ...
    if has_free:
        footer_contents.append(
            {
                "type": "text",
                "text": "🆓 = ดูฟรี ช่อง 29 Monomax Sports",
                "size": "xs",
                "align": "center",
                "color": "#16a34a",
                "weight": "bold",
                ...
                "contents": [
                    ...
                    },
                    {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": safe_url(team_logo, team_name),
                                "size": "xxs",
                                "flex": 0,
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "flex": 2,
                        "color": (
                            "#D4AF37" if ACTIVE_COMPETITION in (WC_CODE, UCL_CODE) else "#e11d48"
                        ),
                    },
                ],
            }
            ...
            "contents": [
                {
                    ...
                    "text": header_title,
                    "weight": "bold",
                    "color": "#D4AF37" if is_wc else "#ffffff",
                    "size": "sm",
                },
                {
                    "type": "text",
                    "text": "Top Scorers Leaderboard",
                    "weight": "bold",
                    "color": "#ffffff",
                    "size": "xl",
                },
